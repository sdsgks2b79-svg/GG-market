...
// ==========================
// BO‘LIMLAR MENUSI + SAVAT KNOPKASI
// ==========================
async function sendCategories(ctx) {
  ...
  // Doimiy Savat knopkasi
  inlineKeyboard.push([Markup.button.callback("🛒 Savat", "show_cart")]);
...
bot.action(/cat_(.+)/, async (ctx) => {
  ...
  // Savatga qaytish knopkasi
  buttons.push([Markup.button.callback("🛒 Savat", "show_cart")]);
