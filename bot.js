...
// Buyurtmani tasdiqlash va Chek sorash
bot.action('confirm_order', async (ctx) => {
  ctx.reply('Chek chiqarilsinmi?', Markup.inlineKeyboard([
    Markup.button.callback('Ha, chek chiqarilsin ✅', 'generate_check'),
    Markup.button.callback('Yo‘q, faqat buyurtma ✔️', 'confirm_no_check')
  ]));
});
