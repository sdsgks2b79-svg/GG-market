...
// Product pressed => show image and quantity prompt
...
bot.on("text", async ctx => {
  ...
  const txt = ctx.message.text.trim().replace(",",".").replace(/[^0-9.]/g,"");
...
// Qo'shimcha barcha checkout, delivery, payment, PDF handlerlar eski kod bilan bir xil ishlaydi...
// (lokatsiya, yetkazib berish, olib ketish, Click/Naqd to‘lov, PDF yaratish va adminga jo‘natish)
