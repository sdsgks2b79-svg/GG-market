...
bot.on("text", async ctx => {
  ...
  if (pending.unit === "piece") {
    ...
    if (num < product.price) { // foydalanuvchi pul yozgan bo‘lishi mumkin
...
// ----------------- CHECKOUT & DELIVERY -----------------
// (shu yerga oldingi checkout kodni qo‘yamiz, yuqorida berilgan versiya)
